    ...
    <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow p-6">
      ...
      <div className="flex flex-wrap gap-2">
        <a
          ...
          className="flex-1 min-w-[110px] bg-blue-600 text-white px-3 py-2 rounded-lg text-sm sm:text-base font-medium hover:bg-blue-700 transition-colors flex items-center justify-center"
        >
          View on Map
        </a>
        <a
          ...
          className="flex-1 min-w-[110px] bg-purple-600 text-white px-3 py-2 rounded-lg text-sm sm:text-base font-medium hover:bg-purple-700 transition-colors flex items-center justify-center"
        >
          Directions
        </a>
        {organization.phone && (
          <a
            ...
            className="flex-1 min-w-[110px] bg-green-600 text-white px-3 py-2 rounded-lg text-sm sm:text-base font-medium hover:bg-green-700 transition-colors flex items-center justify-center"
          >
            Call Now
          </a>
        )}
        {organization.website && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex-1 min-w-[110px] bg-indigo-600 text-white px-3 py-2 rounded-lg text-sm sm:text-base font-medium hover:bg-indigo-700 transition-colors flex items-center justify-center"
          >
            Website
          </a>
        )}
