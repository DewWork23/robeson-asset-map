          ...
          {filteredProviders.map(provider => (
            <div key={provider.id} className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow p-6">
              ...
              <div className="mt-4 pt-4 border-t border-gray-200 flex gap-2">
                <a
                  href={`/map?org=${encodeURIComponent(provider.id)}`}
                ...
                <a
                  ...
                  className="flex-1 bg-purple-600 text-white px-3 py-2 rounded-lg font-medium hover:bg-purple-700 transition-colors text-center text-sm"
                >
                  Directions
                </a>
                <a
                ...
                {provider.website && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 bg-indigo-600 text-white px-3 py-2 rounded-lg font-medium hover:bg-indigo-700 transition-colors text-center text-sm"
                  >
                    Website
                  </a>
                )}
